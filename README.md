...
| 类型 | 交易所 | 状态 | 最后修改日期 |
| -- | -- | -- | -- |
| Crypto | Bybit | 完成 | 2024-02-07 |
| Crypto | Binance | 开发中 | |
| Crypto | Okex | 待定 | |
| Crypto | HTX | 待定 | |
| | | | |
| Future \| Spot | 上海黄金交易所 | 规划中(飞鼠柜台) | |
| Future \| Spot | 国内期货 | 规划中(易盛V10) | |
| Future \| Spot | 境外期货 | 规划中(易盛V9) | |
| | | | |
| Stock | A股 | 待定(爬虫？) | |
| Stock | 港股 | 待定(富途 or 老虎 or IB) | |
| Stock | 美股 | 待定(富途 or 老虎 or IB) | |
| | | | |
| Foreign | 外汇 | 待定(IB) | |
...
| 주식 | US Stocks | 대기중 (futu 또는 tiger 또는 ib) |  |  
|  |  |  |  |  
| 외환 | 외국환 | 대기중 (IB) |  |  
